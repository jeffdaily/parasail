...
if(AVX2_C_FLAGS)
  ...
  if(WIN32)
    set(AVX2_C_FLAG_CANDIDATES "/arch:AVX2")
  else()
...
if(AVX2_C_FLAGS)
  ...
  unset(HAVE_AVX2_MM256_INSERT_EPI64 CACHE)
...
if(AVX2_C_FLAGS)
  ...
  set(SAFE_CMAKE_REQUIRED_FLAGS "${CMAKE_REQUIRED_FLAGS}")
  set(CMAKE_REQUIRED_FLAGS "${AVX2_C_FLAGS}")
  unset(HAVE_AVX2_MM256_INSERT_EPI32 CACHE)
...
if(AVX2_C_FLAGS)
  ...
  set(SAFE_CMAKE_REQUIRED_FLAGS "${CMAKE_REQUIRED_FLAGS}")
  set(CMAKE_REQUIRED_FLAGS "${AVX2_C_FLAGS}")
  unset(HAVE_AVX2_MM256_INSERT_EPI16 CACHE)
...
if(AVX2_C_FLAGS)
  ...
  set(SAFE_CMAKE_REQUIRED_FLAGS "${CMAKE_REQUIRED_FLAGS}")
  set(CMAKE_REQUIRED_FLAGS "${AVX2_C_FLAGS}")
  unset(HAVE_AVX2_MM256_INSERT_EPI8 CACHE)
...
if(AVX2_C_FLAGS)
  ...
  set(SAFE_CMAKE_REQUIRED_FLAGS "${CMAKE_REQUIRED_FLAGS}")
  set(CMAKE_REQUIRED_FLAGS "${AVX2_C_FLAGS}")
  unset(HAVE_AVX2_MM256_EXTRACT_EPI64 CACHE)
...
if(AVX2_C_FLAGS)
  ...
  set(SAFE_CMAKE_REQUIRED_FLAGS "${CMAKE_REQUIRED_FLAGS}")
  set(CMAKE_REQUIRED_FLAGS "${AVX2_C_FLAGS}")
  unset(HAVE_AVX2_MM256_EXTRACT_EPI32 CACHE)
...
if(AVX2_C_FLAGS)
  ...
  set(SAFE_CMAKE_REQUIRED_FLAGS "${CMAKE_REQUIRED_FLAGS}")
  set(CMAKE_REQUIRED_FLAGS "${AVX2_C_FLAGS}")
  unset(HAVE_AVX2_MM256_EXTRACT_EPI16 CACHE)
...
if(AVX2_C_FLAGS)
  ...
  set(SAFE_CMAKE_REQUIRED_FLAGS "${CMAKE_REQUIRED_FLAGS}")
  set(CMAKE_REQUIRED_FLAGS "${AVX2_C_FLAGS}")
  unset(HAVE_AVX2_MM256_EXTRACT_EPI8 CACHE)

...
#ifdef ALIGN_EXTRA
#define FNAME nw_stats_striped_debug
#else
#define FNAME nw_stats_striped
#endif
        ...
        )
{
    ...
    *matches = (signed short) _mm_extract_epi16 (vHM, 7);
    *length = (signed short) _mm_extract_epi16 (vHL, 7);

...
#ifdef ALIGN_EXTRA
#define FNAME nw_stats_striped_128_8_debug
#else
        ...
        )
{
    ...
    for (j=0; j<s2Len; ++j) {
        ...
        __m128i vHM = _mm_slli_si128(pvHMStore[segLen - 1], 1);
        __m128i vHL = _mm_slli_si128(pvHLStore[segLen - 1], 1);
        ...
        for (i=0; i<segLen; ++i) {
            ...
            __m128i case2not = _mm_cmplt_epi8(vF,vE);

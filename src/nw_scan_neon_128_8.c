...
#ifdef PARASAIL_TABLE
#define FNAME parasail_nw_table_scan_neon_128_8
#define PNAME parasail_nw_table_scan_profile_neon_128_8
#else
#ifdef PARASAIL_ROWCOL
#define FNAME parasail_nw_rowcol_scan_neon_128_8
#define PNAME parasail_nw_rowcol_scan_profile_neon_128_8
#else
#define FNAME parasail_nw_scan_neon_128_8
#define PNAME parasail_nw_scan_profile_neon_128_8
#endif
#endif

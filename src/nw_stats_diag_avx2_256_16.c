        ...
        const int open, const int gap, const parasail_matrix_t *matrix)
{
    ...
    vNegInf0 = _mm256_insert_epi16_rpl(vZero, NEG_LIMIT, 15);
    ...
    _HM_pr = parasail_memalign_int16_t(32, s2Len+PAD2);
    _HS_pr = parasail_memalign_int16_t(32, s2Len+PAD2);
    _HL_pr = parasail_memalign_int16_t(32, s2Len+PAD2);
    _F_pr  = parasail_memalign_int16_t(32, s2Len+PAD2);
    _FM_pr = parasail_memalign_int16_t(32, s2Len+PAD2);
    _FS_pr = parasail_memalign_int16_t(32, s2Len+PAD2);
    _FL_pr = parasail_memalign_int16_t(32, s2Len+PAD2);
    ...
    for (i=0; i<s1Len; i+=N) {
        ...
        for (j=0; j<s2Len+PAD; ++j) {
            ...
            vF_opn = _mm256_subs_epi16(vNH, vOpen);
            vF_ext = _mm256_subs_epi16(vF, vGap);
            ...
            vE_opn = _mm256_subs_epi16(vWH, vOpen);
            vE_ext = _mm256_subs_epi16(vE, vGap);
            ...
            vWL = _mm256_blendv_epi8(
                    ...
                    _mm256_adds_epi16(vNWL, vOne), case1);

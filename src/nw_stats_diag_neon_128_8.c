...
#ifdef PARASAIL_TABLE
#define FNAME parasail_nw_stats_table_diag_neon_128_8
#else
#ifdef PARASAIL_ROWCOL
#define FNAME parasail_nw_stats_rowcol_diag_neon_128_8
#else
        ...
        const int open, const int gap, const parasail_matrix_t *matrix)
{
    ...
    vNegInf0 = simde_mm_insert_epi8(vZero, NEG_LIMIT, 15);

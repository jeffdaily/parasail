...
#ifdef PARASAIL_TABLE
#define FNAME nw_stats_table_striped_avx2_256_64
#else
#define FNAME nw_stats_striped_avx2_256_64
#endif
        ...
        const int open, const int gap, const parasail_matrix_t *matrix)
{
    ...
    for (j=0; j<s2Len; ++j) {
        ...
        vH = _mm256_insert_epi64(vH, boundary[j], 0);
        ...
        for (k=0; k<segWidth; ++k) {
            ...
            vF = _mm256_insert_epi64(vF, tmp2, 0);
    ...
    /* extract last value from the last column */
    {
        ...
        matches = (int64_t) _mm256_extract_epi64 (vHM, 3);
        similar = (int64_t) _mm256_extract_epi64 (vHS, 3);
        length = (int64_t) _mm256_extract_epi64 (vHL, 3);
    }

...
#ifdef PARASAIL_TABLE
#define FNAME parasail_nw_stats_table_striped_neon_128_8
#define PNAME parasail_nw_stats_table_striped_profile_neon_128_8
#else
#ifdef PARASAIL_ROWCOL
#define FNAME parasail_nw_stats_rowcol_striped_neon_128_8
#define PNAME parasail_nw_stats_rowcol_striped_profile_neon_128_8
#else
#define FNAME parasail_nw_stats_striped_neon_128_8
#define PNAME parasail_nw_stats_striped_profile_neon_128_8
#endif
#endif

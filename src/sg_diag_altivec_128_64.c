...
#ifdef PARASAIL_TABLE
#define FNAME parasail_sg_flags_table_diag_altivec_128_64
#else
#ifdef PARASAIL_ROWCOL
#define FNAME parasail_sg_flags_rowcol_diag_altivec_128_64
#else
#define FNAME parasail_sg_flags_diag_altivec_128_64
#endif
#endif
        ...
        int s1_beg, int s1_end, int s2_beg, int s2_end)
{
    ...
    vN = _mm_set1_epi64(N);
    vGapN = s1_beg ? _mm_set1_epi64(0) : _mm_set1_epi64(gap*N);
    ...
    vIBoundary = s1_beg ? _mm_set1_epi64(0) : _mm_set_epi64(
            -open-0*gap,
            -open-1*gap);

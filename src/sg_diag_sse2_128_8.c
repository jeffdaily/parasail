...
#ifdef PARASAIL_TABLE
#define FNAME parasail_sg_flags_table_diag_sse2_128_8
#else
#ifdef PARASAIL_ROWCOL
#define FNAME parasail_sg_flags_rowcol_diag_sse2_128_8
#else
#define FNAME parasail_sg_flags_diag_sse2_128_8
#endif
#endif

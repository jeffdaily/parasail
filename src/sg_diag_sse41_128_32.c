...
#ifdef PARASAIL_TABLE
#define FNAME sg_table_diag_sse41_128_32
#else
#define FNAME sg_diag_sse41_128_32
#endif
        ...
        const int open, const int gap, const int matrix[24][24])
{
    ...
    int * const restrict s1 = parasail_memalign_int(32, s1Len+PAD2);
    int * const restrict s2B= parasail_memalign_int(32, s2Len+PAD);
    int * const restrict _tbl_pr = parasail_memalign_int(32, s2Len+PAD);
    int * const restrict _del_pr = parasail_memalign_int(32, s2Len+PAD);

...
parasail_func * parasail_sg_scan_32_pointer = &parasail_sg_scan_32_dispatcher;
parasail_func * parasail_sg_scan_16_pointer = &parasail_sg_scan_16_dispatcher;
parasail_func * parasail_sg_scan_8_pointer  = &parasail_sg_scan_8_dispatcher;
parasail_func * parasail_sg_striped_32_pointer = &parasail_sg_striped_32_dispatcher;
parasail_func * parasail_sg_striped_16_pointer = &parasail_sg_striped_16_dispatcher;
parasail_func * parasail_sg_striped_8_pointer  = &parasail_sg_striped_8_dispatcher;
parasail_func * parasail_sg_diag_32_pointer = &parasail_sg_diag_32_dispatcher;
parasail_func * parasail_sg_diag_16_pointer = &parasail_sg_diag_16_dispatcher;
parasail_func * parasail_sg_diag_8_pointer  = &parasail_sg_diag_8_dispatcher;

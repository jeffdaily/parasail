...
#define SG_FNAME9 parasail_sg_qb_db
#define SG_FNAMEA parasail_sg_qe_de
#define SG_FNAMEB parasail_sg
...
#define SG_CASE9 1,0,1,0
#define SG_CASEA 0,1,0,1
#define SG_CASEB 1,1,1,1
...
SG_IMPL(SG_FNAMEA, SG_STATSTRACE, SG_TABCOL, SG_SUFFIX, SG_CASEA) \
SG_IMPL(SG_FNAMEB, SG_STATSTRACE, SG_TABCOL, SG_SUFFIX, SG_CASEB)
...
SG_IMPL_PROF(SG_FNAMEA, SG_STATSTRACE, SG_TABCOL, SG_SUFFIX_PROF, SG_CASEA) \
SG_IMPL_PROF(SG_FNAMEB, SG_STATSTRACE, SG_TABCOL, SG_SUFFIX_PROF, SG_CASEB)

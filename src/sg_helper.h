...
#define SG_FNAME10 parasail_sg_qb_db
#define SG_FNAME11 parasail_sg_qe_de
#define SG_FNAME12 parasail_sg_qx_db
#define SG_FNAME13 parasail_sg_qx_de
#define SG_FNAME14 parasail_sg_qb_dx
#define SG_FNAME15 parasail_sg_qe_dx
...
#define SG_CASE10 1,0,1,0
#define SG_CASE11 0,1,0,1
#define SG_CASE12 1,1,1,0
#define SG_CASE13 1,1,0,1
#define SG_CASE14 1,0,1,1
#define SG_CASE15 0,1,1,1
...
SG_IMPL(SG_FNAME10, SG_STATSTRACE, SG_TABCOL, SG_SUFFIX, SG_CASE10) \
SG_IMPL(SG_FNAME11, SG_STATSTRACE, SG_TABCOL, SG_SUFFIX, SG_CASE11) \
SG_IMPL(SG_FNAME12, SG_STATSTRACE, SG_TABCOL, SG_SUFFIX, SG_CASE12) \
SG_IMPL(SG_FNAME13, SG_STATSTRACE, SG_TABCOL, SG_SUFFIX, SG_CASE13) \
SG_IMPL(SG_FNAME14, SG_STATSTRACE, SG_TABCOL, SG_SUFFIX, SG_CASE14) \
SG_IMPL(SG_FNAME15, SG_STATSTRACE, SG_TABCOL, SG_SUFFIX, SG_CASE15)
...
SG_IMPL_PROF(SG_FNAME10, SG_STATSTRACE, SG_TABCOL, SG_SUFFIX_PROF, SG_CASE10) \
SG_IMPL_PROF(SG_FNAME11, SG_STATSTRACE, SG_TABCOL, SG_SUFFIX_PROF, SG_CASE11) \
SG_IMPL_PROF(SG_FNAME12, SG_STATSTRACE, SG_TABCOL, SG_SUFFIX_PROF, SG_CASE12) \
SG_IMPL_PROF(SG_FNAME13, SG_STATSTRACE, SG_TABCOL, SG_SUFFIX_PROF, SG_CASE13) \
SG_IMPL_PROF(SG_FNAME14, SG_STATSTRACE, SG_TABCOL, SG_SUFFIX_PROF, SG_CASE14) \
SG_IMPL_PROF(SG_FNAME15, SG_STATSTRACE, SG_TABCOL, SG_SUFFIX_PROF, SG_CASE15)

...
#ifdef PARASAIL_TABLE
#define FNAME parasail_sg_flags_table_scan_altivec_128_8
#define PNAME parasail_sg_flags_table_scan_profile_altivec_128_8
#else
#ifdef PARASAIL_ROWCOL
#define FNAME parasail_sg_flags_rowcol_scan_altivec_128_8
#define PNAME parasail_sg_flags_rowcol_scan_profile_altivec_128_8
#else
#define FNAME parasail_sg_flags_scan_altivec_128_8
#define PNAME parasail_sg_flags_scan_profile_altivec_128_8
#endif
#endif

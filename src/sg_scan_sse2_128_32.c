...
#ifdef PARASAIL_TABLE
#define FNAME parasail_sg_flags_table_scan_sse2_128_32
#define PNAME parasail_sg_flags_table_scan_profile_sse2_128_32
#else
#ifdef PARASAIL_ROWCOL
#define FNAME parasail_sg_flags_rowcol_scan_sse2_128_32
#define PNAME parasail_sg_flags_rowcol_scan_profile_sse2_128_32
#else
#define FNAME parasail_sg_flags_scan_sse2_128_32
#define PNAME parasail_sg_flags_scan_profile_sse2_128_32
#endif
#endif
        ...
        int s1_beg, int s1_end, int s2_beg, int s2_end)
{
...

    {
        ...
        for (i=segLen-1; i>=0; --i) {
            ...
            vSaturationCheckMin = _mm_min_epi32_rpl(vSaturationCheckMin, vGapper);
        }
    }

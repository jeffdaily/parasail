...
#ifdef PARASAIL_TABLE
#define FNAME parasail_sg_flags_stats_table_diag_avx2_256_8
#else
#ifdef PARASAIL_ROWCOL
#define FNAME parasail_sg_flags_stats_rowcol_diag_avx2_256_8
#else
#define FNAME parasail_sg_flags_stats_diag_avx2_256_8
#endif
#endif
        ...
        int s1_beg, int s1_end, int s2_beg, int s2_end)
{
    ...
    __m256i vGapN = s1_beg ? _mm256_set1_epi8(0) : _mm256_set1_epi8(gap*N);
    ...
    __m256i vIBoundary = s1_beg ? _mm256_set1_epi8(0) : _mm256_set_epi8(
            -open-0*gap,
            -open-1*gap,
            -open-2*gap,
            -open-3*gap,

...
#define SG_STATS
#define SG_SUFFIX _diag_sse2_128_16
#include "sg_helper.h"
...
#ifdef PARASAIL_TABLE
#define FNAME parasail_sg_flags_stats_table_diag_sse2_128_16
#else
#ifdef PARASAIL_ROWCOL
#define FNAME parasail_sg_flags_stats_rowcol_diag_sse2_128_16
#else
#define FNAME parasail_sg_flags_stats_diag_sse2_128_16
#endif
#endif
        ...
        int s1_beg, int s1_end, int s2_beg, int s2_end)
{
    ...
    __m128i vGapN = s1_beg ? _mm_set1_epi16(0) : _mm_set1_epi16(gap*N);
    ...
    __m128i vIBoundary = s1_beg ? _mm_set1_epi16(0) : _mm_set_epi16(
            -open-0*gap,
            -open-1*gap,
            -open-2*gap,
            -open-3*gap,

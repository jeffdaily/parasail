...
#ifdef PARASAIL_TABLE
#define FNAME parasail_sg_stats_table_diag_sse41_128_32
#else
#ifdef PARASAIL_ROWCOL
#define FNAME parasail_sg_stats_rowcol_diag_sse41_128_32
#else
#define FNAME parasail_sg_stats_diag_sse41_128_32
#endif
#endif
        ...
        const int open, const int gap, const parasail_matrix_t *matrix)
{
    ...
    __m128i vNegInf0 = _mm_insert_epi32(vZero, NEG_LIMIT, 3);

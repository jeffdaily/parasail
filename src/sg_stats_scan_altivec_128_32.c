...
#ifdef PARASAIL_TABLE
#define FNAME parasail_sg_stats_table_scan_altivec_128_32
#define PNAME parasail_sg_stats_table_scan_profile_altivec_128_32
#else
#ifdef PARASAIL_ROWCOL
#define FNAME parasail_sg_stats_rowcol_scan_altivec_128_32
#define PNAME parasail_sg_stats_rowcol_scan_profile_altivec_128_32
#else
#define FNAME parasail_sg_stats_scan_altivec_128_32
#define PNAME parasail_sg_stats_scan_profile_altivec_128_32
#endif
#endif
        ...
        const int open, const int gap)
{
    ...
    vec128i* const restrict pvPm = (vec128i*)profile->profile32.matches;
    vec128i* const restrict pvPs = (vec128i*)profile->profile32.similar;
    ...
    vec128i vNegInfFront = _mm_set_epi32(0,0,0,NEG_LIMIT);
    vec128i vSegLenXgap = _mm_add_epi32(vNegInfFront,
            _mm_slli_si128(_mm_set1_epi32(-segLen*gap), 4));
    vec128i vSegLen = _mm_slli_si128(_mm_set1_epi32(segLen), 4);
#ifdef PARASAIL_TABLE

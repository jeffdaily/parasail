...
#ifdef PARASAIL_TABLE
#define FNAME parasail_sg_flags_stats_table_scan_avx2_256_8
#define PNAME parasail_sg_flags_stats_table_scan_profile_avx2_256_8
#else
#ifdef PARASAIL_ROWCOL
#define FNAME parasail_sg_flags_stats_rowcol_scan_avx2_256_8
#define PNAME parasail_sg_flags_stats_rowcol_scan_profile_avx2_256_8
#else
#define FNAME parasail_sg_flags_stats_scan_avx2_256_8
#define PNAME parasail_sg_flags_stats_scan_profile_avx2_256_8
#endif
#endif

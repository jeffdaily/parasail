...
#define SG_STATS
#define SG_SUFFIX _scan_neon_128_64
#define SG_SUFFIX_PROF _scan_profile_neon_128_64
#include "sg_helper.h"
...
#ifdef PARASAIL_TABLE
#define FNAME parasail_sg_flags_stats_table_scan_neon_128_64
#define PNAME parasail_sg_flags_stats_table_scan_profile_neon_128_64
#else
#ifdef PARASAIL_ROWCOL
#define FNAME parasail_sg_flags_stats_rowcol_scan_neon_128_64
#define PNAME parasail_sg_flags_stats_rowcol_scan_profile_neon_128_64
#else
#define FNAME parasail_sg_flags_stats_scan_neon_128_64
#define PNAME parasail_sg_flags_stats_scan_profile_neon_128_64
#endif
#endif
        ...
        int s1_beg, int s1_end, int s2_beg, int s2_end)
{
    ...
    profile = parasail_profile_create_stats_neon_128_64(s1, s1Len, matrix);
        ...
        int s1_beg, int s1_end, int s2_beg, int s2_end)
{
    ...
    pvPm = (simde__m128i*)profile->profile64.matches;
    pvPs = (simde__m128i*)profile->profile64.similar;
    ...
    vMaxS = vNegLimit;
    vMaxL = vNegLimit;
    vPosMask = simde_mm_cmpeq_epi64(simde_mm_set1_epi64x(position),
            simde_mm_set_epi64x(0,1));
    vNegInfFront = vZero;
    vSegLen = simde_mm_slli_si128(simde_mm_set1_epi64x(segLen), 8);
    ...
    for (j=0; j<s2Len; ++j) {
        ...
        /* extract vector containing last value from column */
        {
            ...
            vMaxH = simde_mm_max_epi64(vMaxH, vH);

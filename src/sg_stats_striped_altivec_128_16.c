...
#ifdef PARASAIL_TABLE
#define FNAME parasail_sg_stats_table_striped_altivec_128_16
#define PNAME parasail_sg_stats_table_striped_profile_altivec_128_16
#define INAME PNAME
#define STATIC
#else
#ifdef PARASAIL_ROWCOL
#define FNAME parasail_sg_stats_rowcol_striped_altivec_128_16
#define PNAME parasail_sg_stats_rowcol_striped_profile_altivec_128_16
#define INAME PNAME
#define STATIC
#else
#define FNAME parasail_sg_stats_striped_altivec_128_16
#ifdef FASTSTATS
#define PNAME parasail_sg_stats_striped_profile_altivec_128_16_internal
#define INAME parasail_sg_stats_striped_profile_altivec_128_16
#define STATIC static
#else
#define PNAME parasail_sg_stats_striped_profile_altivec_128_16
#define INAME PNAME
#define STATIC
#endif
#endif
        ...
        const int open, const int gap)
{
    ...
    parasail_result_t *result = parasail_sg_striped_profile_altivec_128_16(profile, s2, s2Len, open, gap);

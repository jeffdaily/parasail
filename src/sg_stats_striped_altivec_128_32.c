...
#define SG_STATS
#define SG_SUFFIX _striped_altivec_128_32
#define SG_SUFFIX_PROF _striped_profile_altivec_128_32
#include "sg_helper.h"
...
#ifdef PARASAIL_TABLE
#define FNAME parasail_sg_flags_stats_table_striped_altivec_128_32
#define PNAME parasail_sg_flags_stats_table_striped_profile_altivec_128_32
#else
#ifdef PARASAIL_ROWCOL
#define FNAME parasail_sg_flags_stats_rowcol_striped_altivec_128_32
#define PNAME parasail_sg_flags_stats_rowcol_striped_profile_altivec_128_32
#else
#define FNAME parasail_sg_flags_stats_striped_altivec_128_32
#define PNAME parasail_sg_flags_stats_striped_profile_altivec_128_32
#define INAME parasail_sg_flags_stats_striped_profile_altivec_128_32_internal
#endif
#endif
        ...
        int s1_beg, int s1_end, int s2_beg, int s2_end)
{
    ...
    vec128i vPosMask = _mm_cmpeq_epi32(_mm_set1_epi32(position),
    ...
    if (INT32_MAX == profile->stop || 0 == profile->stop)
    {
        ...
        /* max in vec */
        score_last = _mm_hmax_epi32(vMaxH);
        ...
        int s1_beg, int s1_end, int s2_beg, int s2_end)
{
    ...
    parasail_result_t *result = parasail_sg_flags_striped_profile_altivec_128_32(profile, s2, s2Len, open, gap, s1_beg, s1_end, s2_beg, s2_end);

...
#ifdef PARASAIL_TABLE
#define FNAME parasail_sg_stats_table_striped_neon_128_16
#define PNAME parasail_sg_stats_table_striped_profile_neon_128_16
#define INAME PNAME
#define STATIC
#else
#ifdef PARASAIL_ROWCOL
#define FNAME parasail_sg_stats_rowcol_striped_neon_128_16
#define PNAME parasail_sg_stats_rowcol_striped_profile_neon_128_16
#define INAME PNAME
#define STATIC
#else
#define FNAME parasail_sg_stats_striped_neon_128_16
#ifdef FASTSTATS
#define PNAME parasail_sg_stats_striped_profile_neon_128_16_internal
#define INAME parasail_sg_stats_striped_profile_neon_128_16
#define STATIC static
#else
#define PNAME parasail_sg_stats_striped_profile_neon_128_16
#define INAME PNAME
#define STATIC
#endif
#endif
        ...
        const int open, const int gap)
{
    ...
    simde__m128i* const restrict vProfileM = (simde__m128i*)profile->profile16.matches;
    simde__m128i* const restrict vProfileS = (simde__m128i*)profile->profile16.similar;
    ...
    const simde__m128i vOne = simde_mm_set1_epi16(1);
        ...
        const int open, const int gap)
{
    ...
    parasail_result_t *result = parasail_sg_striped_profile_neon_128_16(profile, s2, s2Len, open, gap);

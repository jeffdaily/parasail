...
#ifdef PARASAIL_TABLE
#define FNAME parasail_sg_flags_stats_table_striped_neon_128_64
#define PNAME parasail_sg_flags_stats_table_striped_profile_neon_128_64
#else
#ifdef PARASAIL_ROWCOL
#define FNAME parasail_sg_flags_stats_rowcol_striped_neon_128_64
#define PNAME parasail_sg_flags_stats_rowcol_striped_profile_neon_128_64
#else
#define FNAME parasail_sg_flags_stats_striped_neon_128_64
#define PNAME parasail_sg_flags_stats_striped_profile_neon_128_64
#endif
#endif
        ...
        int s1_beg, int s1_end, int s2_beg, int s2_end)
{
    ...
    vProfileM = (simde__m128i*)profile->profile64.matches;
    vProfileS = (simde__m128i*)profile->profile64.similar;

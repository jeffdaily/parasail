...
#define INAME parasail_sg_flags_stats_striped_profile_neon_128_64_internal
#endif
#endif
        ...
        int s1_beg, int s1_end, int s2_beg, int s2_end)
{
    ...
    parasail_result_t *result = parasail_sg_flags_striped_profile_neon_128_64(profile, s2, s2Len, open, gap, s1_beg, s1_end, s2_beg, s2_end);

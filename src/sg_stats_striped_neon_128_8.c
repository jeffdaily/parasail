...
#ifdef PARASAIL_TABLE
#define FNAME parasail_sg_stats_table_striped_neon_128_8
#define PNAME parasail_sg_stats_table_striped_profile_neon_128_8
#define INAME PNAME
#define STATIC
#else
#ifdef PARASAIL_ROWCOL
#define FNAME parasail_sg_stats_rowcol_striped_neon_128_8
#define PNAME parasail_sg_stats_rowcol_striped_profile_neon_128_8
#define INAME PNAME
#define STATIC
#else
#define FNAME parasail_sg_stats_striped_neon_128_8
#ifdef FASTSTATS
#define PNAME parasail_sg_stats_striped_profile_neon_128_8_internal
#define INAME parasail_sg_stats_striped_profile_neon_128_8
#define STATIC static
#else
#define PNAME parasail_sg_stats_striped_profile_neon_128_8
#define INAME PNAME
#define STATIC
#endif
#endif
        ...
        const int open, const int gap)
{
    ...
    const simde__m128i vOne = simde_mm_set1_epi8(1);
        ...
        const int open, const int gap)
{
    ...
    parasail_result_t *result = parasail_sg_striped_profile_neon_128_8(profile, s2, s2Len, open, gap);

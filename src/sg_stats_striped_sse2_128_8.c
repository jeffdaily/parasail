...
#ifdef PARASAIL_TABLE
#define FNAME parasail_sg_flags_stats_table_striped_sse2_128_8
#define PNAME parasail_sg_flags_stats_table_striped_profile_sse2_128_8
#else
#ifdef PARASAIL_ROWCOL
#define FNAME parasail_sg_flags_stats_rowcol_striped_sse2_128_8
#define PNAME parasail_sg_flags_stats_rowcol_striped_profile_sse2_128_8
#else
#define FNAME parasail_sg_flags_stats_striped_sse2_128_8
#define PNAME parasail_sg_flags_stats_striped_profile_sse2_128_8
#define INAME parasail_sg_flags_stats_striped_profile_sse2_128_8_internal
#endif
#endif
        ...
        int s1_beg, int s1_end, int s2_beg, int s2_end)
{
    ...
    parasail_result_t *result = parasail_sg_flags_striped_profile_sse2_128_8(profile, s2, s2Len, open, gap, s1_beg, s1_end, s2_beg, s2_end);

...
#ifdef PARASAIL_TABLE
#define FNAME parasail_sg_flags_table_striped_altivec_128_32
#define PNAME parasail_sg_flags_table_striped_profile_altivec_128_32
#else
#ifdef PARASAIL_ROWCOL
#define FNAME parasail_sg_flags_rowcol_striped_altivec_128_32
#define PNAME parasail_sg_flags_rowcol_striped_profile_altivec_128_32
#else
#define FNAME parasail_sg_flags_striped_altivec_128_32
#define PNAME parasail_sg_flags_striped_profile_altivec_128_32
#endif
#endif
        ...
        int s1_beg, int s1_end, int s2_beg, int s2_end)
{
    ...
    /* initialize H and E */
    parasail_memset_vec128i(pvHStore, _mm_set1_epi32(0), segLen);
    ...
    for (j=0; j<s2Len; ++j) {
        ...
        vec128i vH = _mm_slli_si128(pvHStore[segLen - 1], 4);

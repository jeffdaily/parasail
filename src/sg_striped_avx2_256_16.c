...
#ifdef PARASAIL_TABLE
#define FNAME parasail_sg_flags_table_striped_avx2_256_16
#define PNAME parasail_sg_flags_table_striped_profile_avx2_256_16
#else
#ifdef PARASAIL_ROWCOL
#define FNAME parasail_sg_flags_rowcol_striped_avx2_256_16
#define PNAME parasail_sg_flags_rowcol_striped_profile_avx2_256_16
#else
#define FNAME parasail_sg_flags_striped_avx2_256_16
#define PNAME parasail_sg_flags_striped_profile_avx2_256_16
#endif
#endif
        ...
        int s1_beg, int s1_end, int s2_beg, int s2_end)
{
    ...
    /* initialize H and E */
    {
        ...
        parasail_memset___m256i(pvHStore, _mm256_set1_epi16(0), segLen);

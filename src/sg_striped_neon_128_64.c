...
#ifdef PARASAIL_TABLE
#define FNAME parasail_sg_table_striped_neon_128_64
#define PNAME parasail_sg_table_striped_profile_neon_128_64
#else
#ifdef PARASAIL_ROWCOL
#define FNAME parasail_sg_rowcol_striped_neon_128_64
#define PNAME parasail_sg_rowcol_striped_profile_neon_128_64
#else
#define FNAME parasail_sg_striped_neon_128_64
#define PNAME parasail_sg_striped_profile_neon_128_64
#endif
#endif
        ...
        const int open, const int gap)
{
    ...
    /* initialize H and E */
    parasail_memset_simde__m128i(pvHStore, simde_mm_set1_epi64x(0), segLen);

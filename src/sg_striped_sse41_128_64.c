...
#ifdef PARASAIL_TABLE
#define FNAME parasail_sg_flags_table_striped_sse41_128_64
#define PNAME parasail_sg_flags_table_striped_profile_sse41_128_64
#else
#ifdef PARASAIL_ROWCOL
#define FNAME parasail_sg_flags_rowcol_striped_sse41_128_64
#define PNAME parasail_sg_flags_rowcol_striped_profile_sse41_128_64
#else
#define FNAME parasail_sg_flags_striped_sse41_128_64
#define PNAME parasail_sg_flags_striped_profile_sse41_128_64
#endif
#endif
        ...
        int s1_beg, int s1_end, int s2_beg, int s2_end)
{
    ...
    /* initialize H and E */
    parasail_memset___m128i(pvHStore, _mm_set1_epi64x_rpl(0), segLen);

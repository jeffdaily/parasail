...
#define FNAME parasail_sg_flags_trace_striped_altivec_128_32
#define PNAME parasail_sg_flags_trace_striped_profile_altivec_128_32
        ...
        int s1_beg, int s1_end, int s2_beg, int s2_end)
{
    ...
    vec128i vTMask = _mm_set1_epi32(PARASAIL_ZERO_MASK);
    vec128i vFTMask = _mm_set1_epi32(PARASAIL_F_MASK);

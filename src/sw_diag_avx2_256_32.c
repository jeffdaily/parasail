...
#ifdef PARASAIL_TABLE
#define FNAME parasail_sw_table_diag_avx2_256_32
#else
#ifdef PARASAIL_ROWCOL
#define FNAME parasail_sw_rowcol_diag_avx2_256_32
#else
#define FNAME parasail_sw_diag_avx2_256_32
#endif
#endif
        ...
        const int open, const int gap, const parasail_matrix_t *matrix)
{
    ...
    for (i=0; i<s1Len; i+=N) {
        ...
        for (j=0; j<s2Len+PAD; ++j) {
            ...
            vWscore = _mm256_max_epi32(vWscore, vZero);
             ...
             * max values within the i,j bounds */
            {
                ...
                vCompare = _mm256_cmpgt_epi32(vMax, vMaxUnit);
                if (_mm256_movemask_epi8(vCompare)) {
                    score = _mm256_hmax_epi32_rpl(vMax);
                    vMaxUnit = _mm256_set1_epi32(score);
                    vEndH = vMax;
                    vEndI = vI;
                    vEndJ = vJ;
                }

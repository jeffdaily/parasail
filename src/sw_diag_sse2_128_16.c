...
#ifdef PARASAIL_TABLE
#define FNAME parasail_sw_table_diag_sse2_128_16
#else
#ifdef PARASAIL_ROWCOL
#define FNAME parasail_sw_rowcol_diag_sse2_128_16
#else
#define FNAME parasail_sw_diag_sse2_128_16
#endif
#endif
    ...
    for (i=0; i<s1Len; i+=N) {
        ...
        for (j=0; j<s2Len+PAD; ++j) {
             ...
             * max values within the i,j bounds */
            {
                ...
                __m128i cond_eq = _mm_cmpeq_epi16(vWscore, vMax);

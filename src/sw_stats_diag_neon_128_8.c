...
#ifdef PARASAIL_TABLE
#define FNAME parasail_sw_stats_table_diag_neon_128_8
#else
#ifdef PARASAIL_ROWCOL
#define FNAME parasail_sw_stats_rowcol_diag_neon_128_8
#else
#define FNAME parasail_sw_stats_diag_neon_128_8
#endif
#endif
        ...
        const int open, const int gap, const parasail_matrix_t *matrix)
{
    ...
    vNegInf0 = simde_mm_srli_si128(vNegInf, 1); /* shift in a 0 */
    ...
    for (i=0; i<s1Len; i+=N) {
        ...
        for (j=0; j<s2Len+PAD; ++j) {
            ...
            case0 = simde_mm_cmpeq_epi8(vWH, vZero);

...
#ifdef PARASAIL_TABLE
#define FNAME parasail_sw_stats_table_diag_sse2_128_64
#else
#ifdef PARASAIL_ROWCOL
#define FNAME parasail_sw_stats_rowcol_diag_sse2_128_64
#else
#define FNAME parasail_sw_stats_diag_sse2_128_64
#endif
#endif
        ...
        const int open, const int gap, const parasail_matrix_t *matrix)
{
    ...
    for (i=0; i<s1Len; i+=N) {
        ...
        for (j=0; j<s2Len+PAD; ++j) {
            ...
            case0 = _mm_cmpeq_epi64_rpl(vWH, vZero);

...
#ifdef PARASAIL_TABLE
#define FNAME parasail_sw_stats_table_diag_sse41_128_8
#else
#ifdef PARASAIL_ROWCOL
#define FNAME parasail_sw_stats_rowcol_diag_sse41_128_8
#else
#define FNAME parasail_sw_stats_diag_sse41_128_8
#endif
#endif

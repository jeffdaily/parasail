...
#ifdef PARASAIL_TABLE
#define FNAME sw_stats_table_scan_avx2_256_64
#else
#define FNAME sw_stats_scan_avx2_256_64
#endif
        ...
        const int open, const int gap, const int matrix[24][24])
{
    ...
    for (j=0; j<s2Len; ++j) {
        ...
        for (i=0; i<segLen; ++i) {
            ...
            vHt = _mm256_max_epi64_rpl(vHt, vZero);
            /* statistics */
            ...
            cond_max = _mm256_cmpeq_epi64(vHt, vZero);

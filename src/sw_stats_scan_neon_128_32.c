...
#ifdef PARASAIL_TABLE
#define FNAME parasail_sw_stats_table_scan_neon_128_32
#define PNAME parasail_sw_stats_table_scan_profile_neon_128_32
#else
#ifdef PARASAIL_ROWCOL
#define FNAME parasail_sw_stats_rowcol_scan_neon_128_32
#define PNAME parasail_sw_stats_rowcol_scan_profile_neon_128_32
#else
#define FNAME parasail_sw_stats_scan_neon_128_32
#define PNAME parasail_sw_stats_scan_profile_neon_128_32
#endif
#endif
        ...
        const int open, const int gap)
{
    ...
    pvPm = (simde__m128i*)profile->profile32.matches;
    pvPs = (simde__m128i*)profile->profile32.similar;
    ...
    vMaxL = vNegLimit;
    vMaxHUnit = vNegLimit;
    vSegLen = simde_mm_slli_si128(simde_mm_set1_epi32(segLen), 4);
    vNegInfFront = vZero;
    ...
    for (j=0; j<s2Len; ++j) {
        ...
        for (i=0; i<segLen; ++i) {
            ...
            case0 = simde_mm_cmpeq_epi32(vH, vZero);
...
#endif
            {
                simde__m128i cond_max = simde_mm_cmpgt_epi32(vH, vMaxH);

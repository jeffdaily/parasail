...
#ifdef PARASAIL_TABLE
#define FNAME parasail_sw_stats_table_scan_neon_128_64
#define PNAME parasail_sw_stats_table_scan_profile_neon_128_64
#else
#ifdef PARASAIL_ROWCOL
#define FNAME parasail_sw_stats_rowcol_scan_neon_128_64
#define PNAME parasail_sw_stats_rowcol_scan_profile_neon_128_64
#else
#define FNAME parasail_sw_stats_scan_neon_128_64
#define PNAME parasail_sw_stats_scan_profile_neon_128_64
#endif
#endif
...
#endif
            {
                simde__m128i cond_max = simde_mm_cmpgt_epi64(vH, vMaxH);

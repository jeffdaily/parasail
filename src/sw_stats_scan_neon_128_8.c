...
#ifdef PARASAIL_TABLE
#define FNAME parasail_sw_stats_table_scan_neon_128_8
#define PNAME parasail_sw_stats_table_scan_profile_neon_128_8
#else
#ifdef PARASAIL_ROWCOL
#define FNAME parasail_sw_stats_rowcol_scan_neon_128_8
#define PNAME parasail_sw_stats_rowcol_scan_profile_neon_128_8
#else
#define FNAME parasail_sw_stats_scan_neon_128_8
#define PNAME parasail_sw_stats_scan_profile_neon_128_8
#endif
#endif
        ...
        const int open, const int gap)
{
    ...
    pvPm = (simde__m128i*)profile->profile8.matches;
    pvPs = (simde__m128i*)profile->profile8.similar;
    ...
    vMaxL = vNegLimit;
    vMaxHUnit = vNegLimit;
    vSegLen = simde_mm_slli_si128(simde_mm_set1_epi8(segLen), 1);
    vNegInfFront = vZero;
...
#endif
            {
                simde__m128i cond_max = simde_mm_cmpgt_epi8(vH, vMaxH);

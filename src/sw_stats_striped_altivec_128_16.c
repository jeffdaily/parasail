...
#ifdef PARASAIL_TABLE
#define FNAME parasail_sw_stats_table_striped_altivec_128_16
#define PNAME parasail_sw_stats_table_striped_profile_altivec_128_16
#define INAME PNAME
#define STATIC
#else
#ifdef PARASAIL_ROWCOL
#define FNAME parasail_sw_stats_rowcol_striped_altivec_128_16
#define PNAME parasail_sw_stats_rowcol_striped_profile_altivec_128_16
#define INAME PNAME
#define STATIC
#else
#define FNAME parasail_sw_stats_striped_altivec_128_16
#ifdef FASTSTATS
#define PNAME parasail_sw_stats_striped_profile_altivec_128_16_internal
#define INAME parasail_sw_stats_striped_profile_altivec_128_16
#define STATIC static
#else
#define PNAME parasail_sw_stats_striped_profile_altivec_128_16
#define INAME PNAME
#define STATIC
#endif
#endif
        ...
        const int open, const int gap)
{
    ...
    vec128i* const restrict vProfileM = (vec128i*)profile->profile16.matches;
    vec128i* const restrict vProfileS = (vec128i*)profile->profile16.similar;
    ...
    int16_t length = bias;
    vec128i vBias = _mm_set1_epi16(bias);
    vec128i vBias1 = _mm_adds_epi16(vBias,vOne);
    vec128i vMaxH = vBias;
    vec128i vMaxHUnit = vBias;
    vec128i insert_mask = _mm_cmpgt_epi16(
            _mm_set_epi16(0,0,0,0,0,0,0,1),
            vZero);
    vec128i vSaturationCheckMax = vBias;
    vec128i vPosLimit = _mm_set1_epi16(INT16_MAX);
        ...
        const int open, const int gap)
{
    ...
    if (!parasail_result_is_saturated(result)) {
        ...
        profile_new = parasail_profile_create_altivec_128_16(
                s1_new, s1Len_new, matrix);
        profile_new->stop = result->score;
        result_new = parasail_sw_striped_profile_altivec_128_16(
        ...
        profile_final = parasail_profile_create_stats_altivec_128_16(

        ...
        const int open, const int gap)
{
...
#endif
    vProfile  = (vec128i*)profile->profile32.score;
    vProfileM = (vec128i*)profile->profile32.matches;
    vProfileS = (vec128i*)profile->profile32.similar;
    ...
    vPosLimit = _mm_set1_epi32(INT32_MAX);

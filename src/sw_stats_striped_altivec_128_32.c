...
#ifdef PARASAIL_TABLE
#define FNAME parasail_sw_stats_table_striped_altivec_128_32
#define PNAME parasail_sw_stats_table_striped_profile_altivec_128_32
#define INAME PNAME
#define STATIC
#else
#ifdef PARASAIL_ROWCOL
#define FNAME parasail_sw_stats_rowcol_striped_altivec_128_32
#define PNAME parasail_sw_stats_rowcol_striped_profile_altivec_128_32
#define INAME PNAME
#define STATIC
#else
#define FNAME parasail_sw_stats_striped_altivec_128_32
#ifdef FASTSTATS
#define PNAME parasail_sw_stats_striped_profile_altivec_128_32_internal
#define INAME parasail_sw_stats_striped_profile_altivec_128_32
#define STATIC static
#else
#define PNAME parasail_sw_stats_striped_profile_altivec_128_32
#define INAME PNAME
#define STATIC
#endif
#endif
        ...
        const int open, const int gap)
{
    ...
    vec128i vPosLimit = _mm_set1_epi32(INT32_MAX);
        ...
        const int open, const int gap)
{
    ...
    if (!parasail_result_is_saturated(result)) {
        ...
        profile_new = parasail_profile_create_altivec_128_32(
                s1_new, s1Len_new, matrix);
        profile_new->stop = result->score;
        result_new = parasail_sw_striped_profile_altivec_128_32(
        ...
        profile_final = parasail_profile_create_stats_altivec_128_32(

...
#ifdef PARASAIL_TABLE
#define FNAME parasail_sw_stats_table_striped_altivec_128_64
#define PNAME parasail_sw_stats_table_striped_profile_altivec_128_64
#define INAME PNAME
#define STATIC
#else
#ifdef PARASAIL_ROWCOL
#define FNAME parasail_sw_stats_rowcol_striped_altivec_128_64
#define PNAME parasail_sw_stats_rowcol_striped_profile_altivec_128_64
#define INAME PNAME
#define STATIC
#else
#define FNAME parasail_sw_stats_striped_altivec_128_64
#ifdef FASTSTATS
#define PNAME parasail_sw_stats_striped_profile_altivec_128_64_internal
#define INAME parasail_sw_stats_striped_profile_altivec_128_64
#define STATIC static
#else
#define PNAME parasail_sw_stats_striped_profile_altivec_128_64
#define INAME PNAME
#define STATIC
#endif
#endif
        ...
        const int open, const int gap)
{
    ...
    vec128i* const restrict vProfileM = (vec128i*)profile->profile64.matches;
    vec128i* const restrict vProfileS = (vec128i*)profile->profile64.similar;
    ...
    vec128i* restrict pvHMMax          = parasail_memalign_vec128i(16, segLen);
    vec128i* restrict pvHSMax          = parasail_memalign_vec128i(16, segLen);
    vec128i* restrict pvHLMax          = parasail_memalign_vec128i(16, segLen);
    ...
    vec128i vSaturationCheckMax = vZero;
    vec128i vPosLimit = _mm_set1_epi64(INT64_MAX);
    ...
    for (j=0; j<s2Len; ++j) {
        ...
        for (i=0; i<segLen; ++i) {
            ...
            case1 = _mm_cmpgt_epi64(vEF_opn, vE_ext);
            ...
            case1 = _mm_cmpgt_epi64(vEF_opn, vF_ext);
                ...
                if (! _mm_movemask_epi8(
                            _mm_or_si128(
                                ...
                                _mm_and_si128(
                                    ...
                                    _mm_cmpgt_epi64(vF_ext, vZero)))))
                    goto end;
                /*vF = _mm_max_epi64(vEF_opn, vF_ext);*/
                vF = vF_ext;
                cond = _mm_cmpgt_epi64(vEF_opn, vF_ext);
        ...
        const int open, const int gap)
{
    ...
    if (!parasail_result_is_saturated(result)) {
        ...
        profile_new = parasail_profile_create_altivec_128_64(
                s1_new, s1Len_new, matrix);
        profile_new->stop = result->score;
        result_new = parasail_sw_striped_profile_altivec_128_64(
        ...
        profile_final = parasail_profile_create_stats_altivec_128_64(

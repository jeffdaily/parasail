        ...
        const int open, const int gap)
{
    ...
    __m256i vPosLimit = _mm256_set1_epi64x_rpl(INT64_MAX);
    ...
    for (j=0; j<s2Len; ++j) {
        ...
        for (i=0; i<segLen; ++i) {
            ...
            vHM = _mm256_blendv_epi8(
                    ...
                    _mm256_add_epi64(vHM, _mm256_load_si256(vPM + i)), case1);
            ...
            vHS = _mm256_blendv_epi8(
                    ...
                    _mm256_add_epi64(vHS, _mm256_load_si256(vPS + i)), case1);
            ...
            vHL = _mm256_blendv_epi8(
                    ...
                    _mm256_add_epi64(vHL, vOne), case1);

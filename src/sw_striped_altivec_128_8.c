...
#ifdef PARASAIL_TABLE
#define FNAME parasail_sw_table_striped_altivec_128_8
#define PNAME parasail_sw_table_striped_profile_altivec_128_8
#else
#ifdef PARASAIL_ROWCOL
#define FNAME parasail_sw_rowcol_striped_altivec_128_8
#define PNAME parasail_sw_rowcol_striped_profile_altivec_128_8
#else
#define FNAME parasail_sw_striped_altivec_128_8
#define PNAME parasail_sw_striped_profile_altivec_128_8
#endif
#endif
        ...
        const int open, const int gap)
{
    ...
    int8_t score = bias;
    vec128i vBias = _mm_set1_epi8(bias);
    vec128i vMaxH = vBias;
    vec128i vMaxHUnit = vBias;
    int8_t maxp = INT8_MAX - (int8_t)(matrix->max+1);
    vec128i insert_mask = _mm_cmpgt_epi8(

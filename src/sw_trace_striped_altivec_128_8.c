...
#define FNAME parasail_sw_trace_striped_altivec_128_8
#define PNAME parasail_sw_trace_striped_profile_altivec_128_8
    ...
    for (j=0; j<s2Len; ++j) {
        ...
        for (i=0; i<segLen; ++i) {
...

            {
                ...
                vec128i cond_zero = _mm_cmpeq_epi8(vH, vZero);

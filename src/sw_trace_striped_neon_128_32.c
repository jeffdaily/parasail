...
#define FNAME parasail_sw_trace_striped_neon_128_32
#define PNAME parasail_sw_trace_striped_profile_neon_128_32
        ...
        const int open, const int gap)
{
    ...
    vTZero = simde_mm_set1_epi32(PARASAIL_ZERO);
    ...
    for (j=0; j<s2Len; ++j) {
        ...
        vF = simde_mm_sub_epi32(vZero,vGapO);
        ...
        for (i=0; i<segLen; ++i) {
...

            {
                ...
                simde__m128i cond_zero = simde_mm_cmpeq_epi32(vH, vZero);

...
#define FNAME parasail_sw_trace_striped_neon_128_8
#define PNAME parasail_sw_trace_striped_profile_neon_128_8
        ...
        const int open, const int gap)
{
    ...
    simde__m128i vTZero = simde_mm_set1_epi8(PARASAIL_ZERO);
    ...
    for (j=0; j<s2Len; ++j) {
        ...
        vF = simde_mm_subs_epi8(vZero,vGapO);
        ...
        for (i=0; i<segLen; ++i) {
            ...
            vH_dag = simde_mm_max_epi8(vH_dag, vZero);
...

            {
                ...
                simde__m128i cond_zero = simde_mm_cmpeq_epi8(vH, vZero);
        ...
        for (k=0; k<segWidth; ++k) {
            ...
            for (i=0; i<segLen; ++i) {
                ...
                simde_mm_store_si128(pvHStore + i, vH);
                {
                    ...
                    vHp = simde_mm_max_epi8(vHp, vZero);

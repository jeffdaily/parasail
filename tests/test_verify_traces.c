...
int main(int argc, char **argv)
{
    ...
    if (do_sse2 && parasail_can_use_sse2()) {
        if (test_scores) {
            if (do_nw) check_functions(parasail_nw_trace_sse2, sequences, sizes, limit, matrix, gap);
            if (do_sg) check_functions(parasail_sg_trace_sse2, sequences, sizes, limit, matrix, gap);
            if (do_sw) check_functions(parasail_sw_trace_sse2, sequences, sizes, limit, matrix, gap);
        }
    }
#endif
    ...
    if (do_sse41 && parasail_can_use_sse41()) {
        if (test_scores) {
            if (do_nw) check_functions(parasail_nw_trace_sse41, sequences, sizes, limit, matrix, gap);
            if (do_sg) check_functions(parasail_sg_trace_sse41, sequences, sizes, limit, matrix, gap);
            if (do_sw) check_functions(parasail_sw_trace_sse41, sequences, sizes, limit, matrix, gap);
        }
    }
#endif
    ...
    if (do_avx2 && parasail_can_use_avx2()) {
        if (test_scores) {
            if (do_nw) check_functions(parasail_nw_trace_avx2, sequences, sizes, limit, matrix, gap);
            if (do_sg) check_functions(parasail_sg_trace_avx2, sequences, sizes, limit, matrix, gap);
            if (do_sw) check_functions(parasail_sw_trace_avx2, sequences, sizes, limit, matrix, gap);
        }
    }
#endif
    ...
    {
        if (test_scores) {
            if (do_nw) check_functions(parasail_nw_trace_knc, sequences, sizes, limit, matrix, gap);
            if (do_sg) check_functions(parasail_sg_trace_knc, sequences, sizes, limit, matrix, gap);
            if (do_sw) check_functions(parasail_sw_trace_knc, sequences, sizes, limit, matrix, gap);
        }
    }
#endif
    ...
    if (do_disp) {
        if (test_scores) {
            if (do_nw) check_functions(parasail_nw_trace_disp, sequences, sizes, limit, matrix, gap);
            if (do_sg) check_functions(parasail_sg_trace_disp, sequences, sizes, limit, matrix, gap);
            if (do_sw) check_functions(parasail_sw_trace_disp, sequences, sizes, limit, matrix, gap);
        }
    }
